...
class FrankaDuo_EEF_Inputs(transforms.DataTransformFn):
    ...
    def __call__(self, data: dict) -> dict:
        ...
        match self.model_type:
            case _model.ModelType.PI0 | _model.ModelType.PI05:
                ...
                images = (exterior_image, left_wrist_image, right_wrist_image)
...
@dataclasses.dataclass(frozen=True)
class FrankaDuo_EEF_Outputs(transforms.DataTransformFn):
    def __call__(self, data: dict) -> dict:
